...
| 6 | [Generating Test Traffic](#generating-test-traffic) |
| 7 | [Sample Output](#sample-output) |
| 8 | [Full Source Code](#full-source-code) |
| 9 | [How It Was Built — Full Walkthrough](#how-it-was-built--full-walkthrough) |
...
```bash
git clone https://github.com/rubayahasansinthiya-lab/Network-Security.git
```
...
**3. Create the sniffer script**
Copy the code from the [Full Source Code](#full-source-code) section below and save it as `sniffer.py` in this folder.

**4. Run the sniffer** *(root privileges required for raw sockets)*
```bash
...
```text
Ethernet Frame:
	 - Destination: 52:54:00:12:35:00, Source: 08:00:27:16:0E:22, Protocol: 8
	 - IPv4 Packet:
		 - Version: 4, Header Length: 20, TTL: 64
		 - Protocol: 6, Source: 10.0.2.15, Target: 142.251.153.119
	 - TCP Segment:
		 - Source Port: 44108, Destination Port: 80
		 - Sequence: 2051690668, Acknowledgment: 327958351
		 - Flags:
			 - URG: 0, ACK: 1, PSH: 1, RST: 0, SYN: 0, FIN: 0
		 - Data:
			   \x47\x45\x54\x20\x2f\x20\x48\x54\x54\x50\x2f\x31\x2e\x31\x0d\x0a
			   \x48\x6f\x73\x74\x3a\x20\x67\x6f\x6f\x67\x6c\x65\x2e\x63\x6f\x6d
			   \x0d\x0a\x0d\x0a
```
...
> **Important:** If you tried to unpack data using the wrong function (for example, unpacking TCP data using the ICMP function), it would cause errors — since the data isn't structured that way. That's why checking the protocol number first is essential.
...
> If you don't run it with the correct privileges, the program will **not work properly** — it won't have permission to access raw network data.
